...
# Load 4D fMRI data
func_path = r"C:\Users\mathi\OneDrive\Desktop\Final Project\Travelling waves data\VOL147_fMRI_binRivalry_run1_WAVE.nii"
...
# Load the mask
mask_path = r"C:\Users\mathi\OneDrive\Desktop\Final Project\Travelling waves data\lh-benson_periphery_V1_restrictedAngle_functional_thr_wave2"
...
plt.ylim([-0.8, 1.2])
plt.title("Voxel Responses for the 'Wave' Trial")
plt.show()
...
sitk.WriteImage(phase_img, r"C:\Users\mathi\OneDrive\Desktop\Final Project\phase_delay\phase_delay_map_wave_lh.nii.gz")
