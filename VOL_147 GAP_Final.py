...
# Load 4D fMRI data
func_path = r"C:\Users\mathi\OneDrive\Desktop\Final Project\Travelling waves data\VOL147_fMRI_binRivalry_run2_GAP.nii"
...
# Load the mask
mask_path = r"C:\Users\mathi\OneDrive\Desktop\Final Project\Travelling waves data\lh-benson_periphery_V1_restrictedAngle_functional_thr_gap.nii"
...
plt.ylim([-0.8, 1.2])
plt.title("Voxel Responses for the 'Gap' Trial")
plt.show()
...
sitk.WriteImage(phase_img, r"C:\Users\mathi\OneDrive\Desktop\Final Project\phase_delay\phase_delay_map_gap_lh.nii.gz")
